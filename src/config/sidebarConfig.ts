...
export const sidebarConfig: Record<UserRole, SidebarItem[]> = {
  ...
  [UserRole.HOSPITAL_ADMIN]: [
    ...
    { title: 'Service Catalog', path: '/service-catalog', icon: 'Package' },
    { title: 'Departments', path: '/departments', icon: 'Building2' },
    { title: 'Test Booking', path: '/test-booking', icon: 'FlaskConical' },
    { title: 'Operation Scheduling', path: '/operation-scheduling', icon: 'CalendarClock' },
    { title: 'Operation Theatre', path: '/operation-theatre', icon: 'LayoutGrid' },
    { title: 'Lab Reports', path: '/lab-reports', icon: 'FileUp' },
    { title: 'Department Analytics', path: '/department-analytics', icon: 'PieChart' },
  ...
  [UserRole.PATIENT]: [
    ...
    { title: 'Book Lab Test', path: '/test-booking', icon: 'FlaskConical' },
    { title: 'My Claims', path: '/my-claims', icon: 'FileText' },
    { title: 'Invoices', path: '/billing', icon: 'Receipt' },
    { title: 'Make Payment', path: '/make-payment', icon: 'IndianRupee' },
  ...
  [UserRole.DOCTOR]: [
    ...
    { title: 'Assign Tests & Care', path: '/doctor-assign-care', icon: 'Stethoscope' },
    { title: 'Settings', path: '/settings', icon: 'Settings' },
  ],
};
